...
"""Verify that starting fuertecoind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fuertecoind with -h for help text")
        ...
        self.log.info("Start fuertecoind with -version for version information")
