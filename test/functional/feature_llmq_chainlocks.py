...
from test_framework.test_framework import FuertecoinTestFramework
...
class LLMQChainLocksTest(FuertecoinTestFramework):
    def set_test_params(self):
        self.set_fuertecoin_test_params(6, 5, fast_dip3_enforcement=True)
