Contributing to Fuertecoin Core
============================

The Fuertecoin Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to fuertecoin-qt
...
[Translation Process](https://github.com/gitfuec/fuertecoin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Fuertecoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Fuertecoin
Network Protocol consensus changes.

Whether a pull request is merged into Fuertecoin Core rests with the project merge
...
Patches that change Fuertecoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Fuertecoin consensus, it must have been
...
The review process is normally fairly responsive on the Fuertecoin Core repository, however
...
The project leader is the release manager for each Fuertecoin Core release.
