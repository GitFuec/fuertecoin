...
rm -f src/config/fuertecoin-config.h
...
rm -rf test_bitcoin.coverage/ fuertecoin-gtest.coverage/ total.coverage/
...
clean_exe src/fuertecoin-cli
clean_exe src/fuertecoind
clean_exe src/fuertecoin-gtest
clean_exe src/fuertecoin-tx
clean_exe src/test/test_fuertecoin
clean_exe src/test/test_fuertecoin_fuzzy
...
clean_dep . src/config/fuertecoin-config.h.in
