    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  fuertecoin-qt [command-line options]                     \n";
...
All the Fuertecoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 FUEC, 0.01 FUEC, 0.1 FUEC, 1 FUEC and 10 FUEC -- sort of like the paper money you use every day.</li> \
