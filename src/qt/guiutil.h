...
/** Utility functions used by the Fuertecoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "fuertecoin:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load fuertecoin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a fuertecoin specific theme is activated (light/dark).*/
