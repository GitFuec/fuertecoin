...
#ifndef FUERTECOIN_ARITH_UINT256_H
#define FUERTECOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Fuertecoin only uses this "compact" format for encoding difficulty
...
#endif // FUERTECOIN_ARITH_UINT256_H
