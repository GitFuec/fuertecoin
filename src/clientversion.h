...
#error Client version information missing: version is not defined by fuertecoin-config.h or in any other way
#endif
...
/**
 * fuertecoind-res.rc includes this file, but it cannot cope with real c++ code.
