...
{
    const char* pszTimestamp = "Fuertecoin, Best coin of Gamers 09/Sep/2023.";
    const CScript genesisOutputScript = CScript() << ParseHex("04763fea3dedbf90d860ee24c2bb75bb7ccbc8c0dceea14ec2d3dd41fb61234e05f128fc6b2d6553e799ba90bf5dfc459657dc6327d73c966e40635b7a11c8ea9c") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Fuertecoin: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Fuertecoin: 2 minutes
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_V17].nStartTime = 1693951201; // Sep 06, 2023 00:00:01hrs
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000000000bf7898fbb98"); // block 140000 chainwork

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x1f818ebb4d7a61f0da190c37229907611844361946c2bc4b89336bc254d6d89c"); // block hash for 140000
        ...
        pchMessageStart[2] = 0x33;//E
        pchMessageStart[3] = 0x28;//C
        nDefaultPort = 2023;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1694236745, 987, 0x20001fff, 4, 5000 * COIN);
        VerifyGenesisPOW(genesis, "main");
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa1966cba18b88c60b3eb7af933e3e7266c3783ea771f55f90f66bd7ddb1422f3"));
        assert(genesis.hashMerkleRoot == uint256S("0x61b7df780b34cfc58d19e36788cae54fddf6002c5e819ce5aad7613f2930d421"));

        vSeeds.emplace_back("node1.fuertecoin.network");
        vSeeds.emplace_back("node2.fuertecoin.network");
        vSeeds.emplace_back("node3.fuertecoin.network");
        vSeeds.emplace_back("node4.fuertecoin.network");
        vSeeds.emplace_back("node5.fuertecoin.network");
        vSeeds.emplace_back("node6.fuertecoin.network");
        vSeeds.emplace_back("node7.fuertecoin.network");
        vSeeds.emplace_back("node8.fuertecoin.network");
        vSeeds.emplace_back("node9.fuertecoin.network");
        vSeeds.emplace_back("node10.fuertecoin.network");
        vSeeds.emplace_back("node11.fuertecoin.network");
        vSeeds.emplace_back("node12.fuertecoin.network");
        vSeeds.emplace_back("node13.fuertecoin.network");
        vSeeds.emplace_back("node14.fuertecoin.network");
        vSeeds.emplace_back("node15.fuertecoin.network");

        // Fuertecoin addresses start with 'F'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,35);
        // Fuertecoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,95);
        // Fuertecoin private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Fuertecoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xAD, 0xE3};
        // Fuertecoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Fuertecoin BIP44 coin type is '5'
...
//        	exit(0);
//        }
//		consensus.nFounderPayment = FounderPayment(rewardStructures, 0, "address"); // amount and address
        ...
        nFulfilledRequestExpireTime = 60*60; // fulfilled requests expire in 1 hour
    		vSporkAddresses = {"FR7rmpVUU8ystgBjeUdPBmcw3zycJt3jzp"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = {
          {  {5000, uint256S("0x8cf9eca2c38a47b8515242d6db236aa67a0cdbbf95c2e73717f476d339ee8999")},
             {7000, uint256S("0x69afd3f3504258e04f7540bb84edf4a213b36e6e5f7c0e7db324e26377f858e9")},
             {9000, uint256S("0xdda56bce5bcffad58dd20747b38f5bfb8a1b4e39bb186f0e6966000e104d1945")},
             {11000, uint256S("0x6b9fd407b209332660d48cb6a6a97436473d44bc2649688617b5ab044b2a3ae0")},
             {13000, uint256S("0x26655d12dcd8d73dd9372e81e1000956b78aa46c828c3788b5da5e673e25915c")},
             {30000, uint256S("0xa3b8794a262acf82cdfdc43143ea8f79aa4746ec37682debdcee6ce407e384bb")},
             {50000, uint256S("0x59b94993c259bc923d0a0cdf38df5cfb43d37f12347ca41ea36072cecb2f505d")},
             {70000, uint256S("0x5b3ed5565b3f9c5a3258709d207e778b97ac748501262a10596b7ab4891e185b")},
             {100000, uint256S("0x86bd0753489517f9d9c0f752bc45e811f33f2a1dc7f5349de77d786c9ce65b84")},
             {120000, uint256S("0x6b2dd893ef61b22e1888f6d9c9a1eeb56f50e77b1706ad1b6aa1b53f568eb3e9")},
          }
        };

        chainTxData = ChainTxData{
            1694236745,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Fuertecoin: 1 day
        consensus.nPowTargetSpacing = 60; // Fuertecoin: 1 minutes
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_V17].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_V17].nStartTime = 1661983201; // Sept 01, 2022 00:00:01hrs
        consensus.vDeployments[Consensus::DEPLOYMENT_V17].nTimeout = 1693519201; // Sept 01, 2023 00:00:01hrs
        ...
        pchMessageStart[0] = 0x67; //T
        pchMessageStart[1] = 0x36; //F
        pchMessageStart[2] = 0x67; //U
        pchMessageStart[3] = 0x36; //E
        nDefaultPort = 19699;
        nPruneAfterHeight = 1000;
        genesis = CreateGenesisBlock(1694236845, 3031, 0x20001fff, 4, 5000 * COIN);
        VerifyGenesisPOW(genesis, "testnet");

        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc6e21ca8533f5e4cbe232d0a45c0241cfa550ee0d5d00d82f3a41ac7fcf756cc"));
        assert(genesis.hashMerkleRoot == uint256S("0x61b7df780b34cfc58d19e36788cae54fddf6002c5e819ce5aad7613f2930d421"));
        ...
        vSeeds.emplace_back("ndtest.fuertecoin.network");

        // Testnet Fuertecoin addresses start with 'r'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,95);
        // Testnet Fuertecoin script addresses start with '8' or '9'
        ...
        // Testnet Fuertecoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Fuertecoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Fuertecoin BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        consensus.nFounderPayment = FounderPayment(rewardStructures, 272200, "fG7GXVWonKLYjRa23XTHZX6bmabwgJLHH9");
        ...
        vSporkAddresses = {"fG7GXVWonKLYjRa23XTHZX6bmabwgJLHH9"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;
        ...
        chainTxData = ChainTxData{
            1694236845, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        genesis = CreateGenesisBlock(1645942755, 2633, 0x20001fff, 4, 5000 * COIN);
        VerifyGenesisPOW(genesis, "devnet");
        consensus.hashGenesisBlock = genesis.GetHash();
//      std::cout << "hash: " << consensus.hashGenesisBlock.ToString() << std::endl;
        assert(consensus.hashGenesisBlock == uint256S("0xe1989ac9a34d07305498b60f0cb5583b7aea4faf2f8754f8014cfdf5a68d04e3"));
        assert(genesis.hashMerkleRoot == uint256S("0x61b7df780b34cfc58d19e36788cae54fddf6002c5e819ce5aad7613f2930d421"));

        consensus.nFutureRewardShare = Consensus::FutureRewardShare(0.8,0.2,0.0);

        std::vector<FounderRewardStructure> rewardStructures = {  {INT_MAX, 5}  };// 5% founder/dev fee forever
        consensus.nFounderPayment = FounderPayment(rewardStructures, 200, "yNWuiBz8ewqKi2mGhzBw25hVxRnXoWKzt4");


        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("evo.fuertecoin.network",  "devnet.fuertecoin.network"));

        // Testnet Fuertecoin addresses start with 'y'
        ...
        nPoolNewMaxParticipants = 20;
        nFulfilledRequestExpireTime = 5*60; // fulfilled requests expire in 5 minutes
        vSporkAddresses = {"yNWuiBz8ewqKi2mGhzBw25hVxRnXoWKzt4"};
        nMinSporkKeys = 1;
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("e1989ac9a34d07305498b60f0cb5583b7aea4faf2f8754f8014cfdf5a68d04e3")},
            }
        };
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        genesis = CreateGenesisBlock(1694237045, 2, 0x207fffff, 4, 5000 * COIN);
        VerifyGenesisPOW(genesis, "regtest-CONTINUE");
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe1989ac9a34d07305498b60f0cb5583b7aea4faf2f8754f8014cfdf5a68d04e3"));
        assert(genesis.hashMerkleRoot == uint256S("0x61b7df780b34cfc58d19e36788cae54fddf6002c5e819ce5aad7613f2930d421"));
        consensus.nFutureRewardShare = Consensus::FutureRewardShare(0.8,0.2,0.0);
        ...
        fBIP9CheckSmartnodesUpgraded = false;
        std::vector<FounderRewardStructure> rewardStructures = {  {INT_MAX, 5}  };// 5% founder/dev fee forever
        consensus.nFounderPayment = FounderPayment(rewardStructures, 500, "yNWuiBz8ewqKi2mGhzBw25hVxRnXoWKzt4");

        checkpointData = {
            {
                {0, uint256S("c39d4d42836329d5f8bd959527cec61810cb5cb02a1ef834176a15ccc0fc72a4")},
            }
        };
        ...
        // Regtest Fuertecoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Fuertecoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Fuertecoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Fuertecoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Fuertecoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
