...
//! Interface for the src/evo part of a fuertecoin node (fuertecoind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a fuertecoin node (fuertecoind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a fuertecoin node (fuertecoind process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a fuertecoin node (fuertecoind process).
class Node
{
public:
    virtual ~Node() {}
