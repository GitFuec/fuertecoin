...
This mechanism has been integrated into Bitcore-Node-Fuertecoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gitfuec/insight-api-fuertecoin#web-socket-api](https://github.com/gitfuec/insight-api-fuertecoin#web-socket-api)
* API: [https://github.com/gitfuec/insight-api-fuertecoin#instantsend-transactions](https://github.com/gitfuec/insight-api-fuertecoin#instantsend-transactions)
