...
* fuertecoin.conf: contains configuration settings for fuertecoind or fuertecoin-qt
* fuertecoind.pid: stores the process id of fuertecoind while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by fuertecoind or fuertecoin-qt
