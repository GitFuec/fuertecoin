...
This document provides guidelines for internationalization of the Fuertecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `fuertecoin_en.ts` remains unchanged.
